...
with open('json/precision/String_search_single trié.json', 'r') as f:
...
ax.set_title('Precision for single string Search', fontsize=12)
...
plt.tight_layout()
plt.show()
plt.savefig("results/" + now.strftime("%Y%m%d%H%M") + "single_precision.pdf")
